...
num_Classs = 6;
target = load('C:\tmp\DNN\RGBLUV\test_targets_32_shift_6_110040.mat');
target = target.data';
% img = load('F:\RGBLUV\tmp_32_train_test\test_digits_193379x6144.mat');
% img = load('C:\tmp\temp\test_digits_32_193379x6144.mat');
% img = img.data;
indx = load('C:\tmp\DNN\RGBLUV\test_index_32_shift_6_var_110040.mat');
indx = indx.data;
...
tag ='ford_6ch_5var_32patch_6class_trts_seperate_conv20141127';
...
set(gca,'XTick',1:6,...                         %# Change the axes tick marks
        'XTickLabel',{'Class-0','Class-1','Class-2','Class-3','Class-4','Class-5'},...  %#   and tick labels
        'YTick',1:6,...
        'YTickLabel',{'Class-0','Class-1','Class-2','Class-3','Class-4','Class-5'},...
        'TickLength',[0 0]);
