...
\begin{figure}[htbp]
    ...
    {
        \includegraphics[scale=0.3]{Figures/ford_GrayLUVch_5var_32patch_9class_trts_seperate_filtw999_conv120414_epoch_299_patch_level.png}
        \label{fig:patch_level_cm_GrLUV}
    }
    \hspace{0.5cm}
    \subfigure[Image level confusion matrix (76.69\% accuracy)]
    {
        \includegraphics[scale=0.3]{Figures/ford_GrayLUVch_5var_32patch_9class_trts_seperate_filtw999_conv120414_epoch_299_image_level.png}
