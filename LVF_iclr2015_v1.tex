...
\begin{figure}[htbp]
    ...
    {
        \includegraphics[scale=0.3]{Figures/ellipse_final_small.png}
        \label{fig:Figures_Ellipse}
    }
    \hspace{0.5cm}
    \subfigure[Stacking of $p\times p$ patch over all the different channels]
    {
        \includegraphics[scale=0.6]{Figures/ImagePatchChannel.pdf}
