...
\begin{figure}[htbp]
    ...
    {
        \includegraphics[scale=0.4]{Figures/ImagePatchChannel_v2.pdf}
...
% \begin{figure}[htbp]
%     \centering
%     \subfigure[Training and testing error plot for \emph{GrLUV} input channels with $filter~size = 9$ over various training epochs]
%     {
%         \includegraphics[scale=0.3]{ford_GrayLUVch_5var_32patch_9class_trts_seperate_filtw999_conv120414_figure.png}
%         \label{fig:error_plot}
%     }
%     \hspace{0.2cm}
%     \subfigure[Performance using temporal information]
%     {
%         \includegraphics[scale=0.4]{temporal_lidar_iclr.pdf}
%         \label{fig:temporal_figure}
%     }
%     \caption{Results for \emph{GrLUV} input channels with $filter size = 9$}
%     \label{fig:results_GrLUV}
% \end{figure}
