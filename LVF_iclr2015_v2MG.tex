...
%%DL multimodal data fusion
Several papers have been written on the topic of using deep neural networks to analyze multimodal sensor inputs including audio/video \cite{Ngiam2011Multimodal}
